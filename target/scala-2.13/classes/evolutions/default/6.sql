...
create table if not exists lift_actions (
  ...
  lift_type_id integer references lift_types(id),
  training_menu_id integer references training_menu(id),
...
insert into lift_actions (lift_type_id, training_menu_id) values (1, 1);
